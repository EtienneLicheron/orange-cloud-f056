...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/orange-cloud-f056)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/orange-cloud-f056
```

A live public deployment of this template is available at [https://orange-cloud-f056.templates.workers.dev](https://orange-cloud-f056.templates.workers.dev)
